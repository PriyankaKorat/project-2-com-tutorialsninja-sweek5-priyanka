...
public class MyAccountsTest extends BaseTest {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() throws InterruptedException {
        ...
        laptopsAndNotebooksPage.enterTheMandatoryField(myAccountsPage.firstName, "Priyanka");
        //3.4 Enter Last Name
        laptopsAndNotebooksPage.enterTheMandatoryField(myAccountsPage.lastName, "Korat" );
        //3.5 Enter Email
        int num = generateRandomNumber();
        laptopsAndNotebooksPage.enterTheMandatoryField(myAccountsPage.email, "sanganipriyanka+"+num+"@gmail.com");
        //3.6 Enter Telephone
        laptopsAndNotebooksPage.enterTheMandatoryField(myAccountsPage.mobile, "07438939393993");
        //3.7 Enter Password
        ...
        laptopsAndNotebooksPage.enterTheMandatoryField(myAccountsPage.termsAndAgree, "Australia");
        Thread.sleep(1000);
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully() throws InterruptedException {
        ...
        int num = generateRandomNumber();
        laptopsAndNotebooksPage.enterTheMandatoryField(myAccountsPage.email, "sanganipriyanka+3665@gmail.com");
        //4.5 Enter Password
        laptopsAndNotebooksPage.enterTheMandatoryField(myAccountsPage.password,"Admin@123");
