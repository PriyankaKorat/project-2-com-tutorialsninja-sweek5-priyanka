...
public class LaptopsAndNotebooksTest extends BaseTest {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        laptopsAndNotebooksPage.enterTheMandatoryField(laptopsAndNotebooksPage.firstName, "Priyanka");
        laptopsAndNotebooksPage.enterTheMandatoryField(laptopsAndNotebooksPage.lastName, "Korat" );
        laptopsAndNotebooksPage.enterTheMandatoryField(laptopsAndNotebooksPage.eMail, "sanganipriyanka+123@gmail.com");
        ...
        laptopsAndNotebooksPage.enterTheMandatoryField(laptopsAndNotebooksPage.city, "Schofield");
        laptopsAndNotebooksPage.enterTheMandatoryField(laptopsAndNotebooksPage.postcode, "254687");
        laptopsAndNotebooksPage.enterTheMandatoryField(laptopsAndNotebooksPage.state, "Sydney");
